...
var Loc = {hero_menu_item: "♲", hero_menu_item_title: "открыть устаревшую страницу героя", shero_menu_item: "герой", hname_capt: "Имя", hname_title: "Перейти к персональной странице геро{я|ини}", monster_name_link_title: "Перейти к описанию этого класса монстров в Энциклобогии", hname_a_capt: "{Герой|Героиня}", hname_a_capt_m: "Герой", hname_a_capt_f: "Героиня", gname_capt: "Имя бога", gname_a_capt: "Бог", hgen_capt: "Пол", age_capt: "Возраст", motto_capt: "Девиз", alignment_capt: "Характер", guild_capt: "Гильдия", guild_link_title: "Перейти к гильд-странице", hlevel_capt: "Уровень", inv_capt: "Инвентарь", health_capt: "Здоровье", quest_capt: "Задание", gold_capt: "Золота", m_killed_capt: "Убито монстров", death_count_capt: "Смертей", win_loss_capt: "Побед / Поражений", win_loss_title: "Открыть подробную статистику побед и поражений", fight_history: "История сражений", last_fight_link: "последняя хроника", ext_stats_link: "расширенная статистика", bricks_capt: "Кирпичей для храма", wood_capt: "Дерева для ковчега", retirement_capt: "Сбережения", aura_capt: "Аура", distance_capt: "Столбов от столицы", distance_back_capt: "Столбов до столицы", town_capt: "Город", network_error: "Ошибка отправки команды. Попробуйте повторить действие позднее.", command_send_error: "Ошибка отправки влияния. Перезагрузите страницу и попробуйте еще раз.", gender_male: "мужской", gender_female: "женский", quest_num: "№", thing_ending: " шт", milestone_ending: "шт", town_wiki_title: "Перейти к описанию города {town} в Энциклобогии", nearby_town: "Город неподалеку: {town}", nearby_town_unkown: "неизвестно", i_intro: "В карманах у геро{я|ини} можно найти:", i_intro_e: "В карманах у геро{я|ини} пусто.", i_intro_o: "В карманах противника можно найти:", i_intro_o_e: "В карманах противника пусто.", i_intro_monster: "Обшарив труп монстра, можно будет найти:", item_activate_no_gp: "{desc} (активируется без затрат праны)", item_activate_no_duel: "Данный предмет нельзя активировать в дуэли", item_activate_no_dungeon: "Данный предмет нельзя активировать в подземелье", item_activate_no_travel: "Данный предмет можно активировать только во время дуэли", item_activate_desc: "{desc} (требуется {godpower}% праны)", item_activate_ne_gp: "{desc} (для активации недостаточно праны, необходимо {godpower}%)", invites_email_name: "E-mail или игровое имя друга", invites_message: "Сообщение", invites_count: "Приглашений", invites_send_button: "Пригласить друга", invite_message: "Присоединяйся! Заведи себе персонального героя, который будет другом моему.", ideabox_intro: "Дорогая редакция, я хочу предложить вам:", ideabox_selector: "", ideabox_other: "другое", ideabox_bug_report: "исправить ошибку", ideabox_idea: "отличную идею", ideabox_payment: "решить проблему с оплатой", ideabox_monster: "монстра", ideabox_artifact: "трофей", ideabox_news_fields: "весть с полей", ideabox_diary: "фразу в дневник", ideabox_content: "удалить неудачные тексты", ideabox_quest: "задание (квест)", ideabox_equipment: "снаряжение", ideabox_duel: "хронику для дуэли", ideabox_dungeon: "хронику подземелья", ideabox_newspaper: "текст для газеты", ideabox_quest_text: "* Текст квеста", ideabox_quest_text_desc: "(по аналогии с текущим заданием геро{я|ини}):", ideabox_quest_end: "Фраза завершения квеста", ideabox_quest_end_desc: "(от лица геро{я|ини}, в дневник):", ideabox_reference: "Пояснение <a href='/forums/show_topic/1237'>отсылки</a>", ideabox_reference_desc: "(если ваш текст что-то пародирует):", ideabox_bug_report_note: "Чем подробнее и детальнее вы опишете ошибку, тем быстрее мы сможем ее найти и исправить. <b>Не нужно</b> присылать ошибки в гласах чужих богов и во фразах из мода (подробнее — в <a href='/forums/show_topic/41'>FAQ</a>). И стоит убедиться, что эта ошибка не <a href=/forums/show_topic/7?page=last'>обсуждается</a> прямо сейчас.", ideabox_idea_note: "Для более успешной генерации идей почитайте <a href='http://wiki.godville.net/%D0%9F%D0%B0%D1%82%D0%B5%D0%BD%D1%82%D0%BD%D0%BE%D0%B5_%D0%B1%D1%8E%D1%80%D0%BE'>патентное бюро</a>. Еще можно обсудить идею на <a href='/forums/show/2'>форуме</a>. Идеи вроде «хочу графику» или «пускай женятся» можно не присылать.", ideabox_payment_note: "Если с оплатой произошли какие-либо проблемы, <b>в первую очередь необходимо обратиться в службы поддержки платежных систем</b> (<a href='http://www.roboxchange.com/Environment/Support/SendMsg.aspx?Culture=ru'>сюда</a> для Robokassa, <a href='http://help.xsolla.com'>сюда</a> для Xsolla) — обычно данные о платеже задерживаются там и до нас доходят не сразу. Если вы отправили SMS, то бывает полезно уточнить ее статус в техподдержке вашего сотового оператора. Если же все варианты исчерпаны, то напишите нам, указав максимум деталей (точное дату и время, номера транзакций, суммы и т.п.).", ideabox_monster_text: "* Название монстра", ideabox_monster_text_desc: "(мужского рода, в именительном падеже и с прописной буквы):", ideabox_monster_artifact_text: "Выпадающий трофей", ideabox_monster_artifact_text_desc: "(в винительном падеже со строчной буквы, необязательно):", ideabox_monster_note: "Пожалуйста, ознакомьтесь с <a href='/forums/show_topic/4'>рекомендациями</a> по придумыванию монстров. И учтите, что отбор проходит меньше 2% предложенного.", ideabox_artifact_text: "Название", ideabox_artifact_text_desc: "(в винительном падеже со строчной буквы):", ideabox_artifact_note: "Пожалуйста, ознакомьтесь с <a  href='/forums/show_topic/4'>рекомендациями</a> по придумыванию трофеев.", ideabox_news_fields_text: "Текст вести", ideabox_news_fields_text_desc: "(в третьем лице, обычно заканчивается многоточием):", ideabox_content_text: "Текст из игры", ideabox_content_text_desc: "(фраза, монстр, трофей, умение...), который выглядит сомнительно и его хочется <b>удалить совсем</b>:", ideabox_content_reference: "Пояснение для голосующих", ideabox_content_reference_desc: "(почему данный текст плох):", ideabox_content_note: "<b>Явные ошибки (дубли, опечатки) нужно отправлять в раздел «исправить ошибку»</b>. Для трофея нужно указывать, из какого монстра он выпал. Очень желательно предварительно погуглить сомнительное и взглянуть <a href='/forums/show_topic/1032'>сюда</a> и на последние сообщения <a href='/forums/show_topic/894'>обсуждения</a>.", ideabox_diary_note: "Рекомендуем ознакомиться с <a href='forums/show_topic/1469'>руководством по написанию фраз</a> и <a href='forums/show_topic/2412'>памяткой креативщику</a>.", ideabox_equipment_type: "Тип снаряжения", ideabox_eq_weapon: "Оружие", ideabox_eq_shield: "Щит", ideabox_eq_head: "Голова", ideabox_eq_talisman: "Талисман", ideabox_eq_legs: "Ноги", ideabox_eq_arms: "Руки", ideabox_eq_body: "Тело", ideabox_equipment_text: "Название:", ideabox_error_max_length: "Жаль, но ваша идея длиннее {len} символов", ideabox_error_min_length: "Жаль, но ваша идея короче {len}-х символов", ideabox_submit_success: "Нижний ящик пополнен!", ideabox_note: "", ideabox_approved_link: "Одобренные идеи", ideabox_send_button: "Отправить в ящик", pantheons_title: "Пантеоны", pantheons_search: "Ищем геро{я|иню} в пантеонах...", p_refresh_title: "Нажмите, чтобы обновить данные в этом блоке", pantheons_place_title: "Посмотреть на геро{я|иню} в пантеоне", pantheons_place_change: "Как изменилась позиция в пантеоне с последнего открытия страницы", pantheons_bl7: "Пантеоны будут доступны после 7-го уровня.", pantheons_no_places: "В ожидании очередного обновления пантеонов...", eq_weapon: "Оружие", eq_shield: "Щит", eq_head: "Голова", eq_body: "Тело", eq_arms: "Руки", eq_legs: "Ноги", eq_talisman: "Талисман", skill_fight: "боевое", skill_trade: "торговое", skill_travel: "трансп.", skill_level_end: "ур.", no_skills: "Умения будут доступны после 15-го уровня.", p_name_capt: "Имя", p_type_capt: "Вид", pet_type_title: "Открыть описание этой породы в Энциклобогии", p_level_capt: "Уровень", p_age_capt: "Возраст", p_status_capt: "Статус", locale: "ru", monster_title: "Противник", gpTitle: "Прана", input_voice_hint: "Введите глас божий", last_voices_title: "Открыть историю последних гласов", send_voice_button: "Изречь", last_voices: "Последние гласы", last_voices_empty: "Сюда попадают отправленные вами гласы. На данный момент список пуст.", last_voices_select: "Выбрать этот глас", last_voices_delete: "Удалить этот глас из списка", voice_too_long: "Слишком длинный глас. Попробуйте уложиться в 100 символов.", encourage_link: "Сделать хорошо", encourage_title: "Одарить геро{я|иню} благодатью и сделать е{му|й} что-то хорошее", punish_link: "Сделать плохо", punish_title: "Прогневаться и сделать геро{ю|ине} или {его|её} противнику что-то плохое", miracle_link: "Сделать чудо", miracle_title: "Сделать что-то эффектное и весьма полезное", to_arena_link: "Отправить на арену", to_chf_link: "Послать на тренировку", to_dungeon_link: "Направить в подземелье", chf_popover_title: "Выбор противника", chf_no_friends: "У вас пока нет ни одного друга", chf_fr_confirm: "Приглашение на спарринг стоит 50% праны, и результаты такого боя не окажут влияния на рейтинги. Пригласить бога {godname} на тренировочный поединок?", chf_pending_title: "Тренировочная дуэль", chf_pending_text: "{godname} приглашает вас на тренировочную дуэль. Принять приглашение?", chf_button_accept: "Принять", chf_button_reject: "Отказаться", arena_unavailable_link: "Дуэли временно недоступны", arena_avaialble_in: "Арена откроется через", dungeon_avaialble_in: "Подземелье откроется через", chf_avaialble_in: "Тренировка возможна через", arena_avaialble_time: " {hours}ч {minutes}мин", arena_avaialble_time_m: " {minutes}мин", send_to_arena_confirm: "Отправить геро{я|иню} на арену для дуэли с другим игроком?", resurrect_link: "Воскресить", resurrect_title: "Воскресить геро{я|иню} в городе (не требует праны)", arena_actions: "Доступно влияний: {actions}", send_to_arena_title: "Мгновенно излечить геро{я|иню} и телепортировать {его|её} в столицу для дуэли", send_to_dungeon_title: "Отправить геро{я|иню} на поиски сокровищ в подземелье", send_to_chf_title: "Пригласить друга на тренировочный поединок", send_to_arena_disabled_title: "Арена, стычки, боссы и подземелья на профилактике", remote_disabled_arena: "Первые два хода пульты обоих богов заморожены...", remote_disabled_fight_over: "Для вашего героя бой окончен", charges_title: "Заряды:", acc_charge: "Аккумулировать", acc_discharge: "Восстановить", acc_discharge_confirm: "У вас уже есть {godpower}% праны. Вы точно хотите восстановить еще один заряд?", acc_title: "Каждым зарядом прано-аккумулятора можно в любой момент восстановить 50% праны", charge_desc: "Упаковать 100% праны в один заряд прано-аккумулятора (но не более 3-х зарядов)", discharge_desc: "Восстановить 50% праны из одного заряда прано-аккумулятора", charge_help_link: "Зарядить", charge_help_title: "Подробнее о прано-аккумуляторе, зарядах и способах их получения", refresh_title: "Попытаться обновить все данные на странице", sort_title: "Изменить порядок записей в дневнике", t_award_title: "Храмовладелец с {time}!", p_award_title: "Зверовод с {time}!", wiki_prefix: "http://wiki.godville.net", wiki_aura_prefix: "аура  {name}", wiki_aura_title: "Перейти к описанию ауры {name} в Энциклобогии", wiki_ab_page: "Босс-монстры#.D0.A1.D0.BF.D0.BE.D1.81.D0.BE.D0.B1.D0.BD.D0.BE.D1.81.D1.82.D0.B8", wiki_general_title: "Перейти к описанию в Энциклобогии", our_domain: "godville.net", shout_up_t: "Этот глас очень интересен и остроумен, а его автор заслуживает награды", shout_down_t: "Этот глас не представляет из себя ничего интересного и остроумного", shout_ppage: "Перейти к персональной странице автора гласа {author}", shout_report: "Сообщить о нарушении", shout_report_confirm: "Вы уверены, что этот глас нарушает правила хорошего тона?", move_hint: "Переместить блок", info_b_capt: "{Герой|Героиня}", stats_b_capt: "{Герой|Героиня}", m_info_b_capt: "{Мой герой|Моя героиня}", o_info_b_capt: "Противник", alls_b_capt: "Союзники", opps_b_capt: "Противники", opp_defeated: "повержен", inventory_b_capt: "Инвентарь", m_inventory_b_capt: "Инвентарь", o_inventory_b_capt: "Инвентарь", invites_b_capt: "Приглашения", pet_b_capt: "Питомец", diary_b_capt: "Дневник {героя|героини}", news_b_capt: "Вести с полей", news_b_capt_short: "Вести с полей", pantheons_b_capt: "Места в пантеонах", pantheons_b_capt_short: "Пантеоны", gl3d_b_capt: "3D", equipment_b_capt: "Снаряжение", m_equipment_b_capt: "Снаряжение", o_equipment_b_capt: "Снаряжение", skills_b_capt: "Умения", ability_s_b_capt: "Способность", ability_b_capt: "Способности", control_b_capt: "Пульт вмешательства в личную жизнь", control_b_capt_short: "Пульт", ideabox_b_capt: "Нижний ящик", map_b_capt: "Карта", duel_arena_capt: "Вести с арены", duel_arena_travel: "Вести с полей", duel_monster_capt: "Хроника боя", duel_challenge_capt: "Тренировочный бой", duel_dungeon_capt: "Хроника подземелья", dual_arena_step: " (шаг {step})", window_title: "{godname} и {god_gender} {hero_gender} {hero_name}", window_title_gm: "его", window_title_gf: "её", window_title_hf: "героиня", window_title_hm: "герой", TurboDisabled: "Турбо-режим отключен. Страница обновляется в обычном режиме. Подробнее о настройке турбо читайте в FAQ", TurboWSEnabling: "", TurboOnConnected: "Страница обновляется в турбо-режиме (Comet). Подробнее о настройке турбо читайте в FAQ", TurboOnConnectedWS: "Страница обновляется в супер-турбо режиме (Websockets). Подробнее о настройке турбо читайте в FAQ", TurboOnStatus: "Пытаемся подключиться к серверу в турбо-режиме...", TurboReconnect: "Переподключение через ", TurboReconnectSec: " сек.", TurboConnectionError: "Ошибка подключения к серверу в турбо-режиме", TurboConnectionErrorWS: "Ошибка подключения к серверу через WebSockets.", TurboConnectionCode: "код: ", TurboConnectionCodeDesc: 'Пожалуйста, ознакомьтесь с <a href="http://godville.net/forums/show_topic/593">подсказками</a> по настройке турбо. А еще можно открыть <a href="http://websocketstest.com">тестовую страницу</a> и сообщить в нижний ящик ваш Result ID.', TurboConnectionErrorTooltip: "Ошибка подключения к серверу в турбо-режиме (страница обновляется в обычном режиме). ", TurboConnectionTempErrorStatus: "Ошибка включения турбо-режима (страница обновляется в обычном режиме). Подробнее о настройке турбо читайте в FAQ", hints_faq_link: "Подробнее обо всех аспектах жизни {героя|героини} можно прочитать в <a target='_blank' href='/help/faq'>FAQ</a>.", hints_more_link: "Подробности — <a href='{url}'>здесь</a>.", hint_close: "закрыть", hint_prev: "< предыдущая", hint_next: "следующая >", blog_notif_capt: "Не может быть!", blog_notif_message: "В <a target='_blank' href='/blog/post/{id}'>блоге</a> появилось новое сообщение от демиургов!", h_voice1: "Молись мне, смертный!", h_voice2: "Бей врага с размахом, {мой герой|моя героиня}!", h_voice3: "Не забудь залечить раны перед подвигами.", h_voice4: "Проверь, нет ли клада под ногами?", a_voice1: "Приветствую, мой славный соперник!", a_voice2: "Бей противника ловчее, {мой герой|моя героиня}!", a_voice3: "Восстанови здоровье, {герой|героиня}!", d_voice1: "Идите на север", d_voice2: "Идите на юг", d_voice3: "Идите на восток", d_voice4: "Идите на запад", fr_button: "Друзья", fr_no_friends: "Кажется, у {вашего героя|вашей героини} еще нет знакомых.", fr_loading: "Загружаем список знакомых...", fr_invite_friend: "Пригласить друга", fr_invites_message: "Текст приглашения", friend_filter_placeholder: "Быстрый поиск", fr_delete_friend_title: "Удалить знакомого из списка друзей и перестать получать от него сообщения", fr_friend_delete_confirm: "Друзья могут пригодиться {герою|героине} в странствиях. Вы точно хотите удалить этого игрока из списка знакомых?", fr_chat_no_messages: "Переписка с данным другом отсутствует.", fr_chat_close_title: "Закрыть окно переписки", fr_msg_delete_title: "Удалить сообщение", fr_msg_delete_all_title: "Удалить переписку с этим другом", fr_msg_delete_all_confirm: "Удалить всю переписку с этим другом?", fr_chat_to_ppage: "Открыть личную страницу в новом окне", fr_new_messages_helper_title: "Есть новые сообщения", fr_more_messages: "Следующие 25 сообщений...", fr_loading_messages: "Идет загрузка сообщений...", fr_msg_too_long: "Сообщение слишком длинное.", fb_fr_invite_header: "Пригласить друга", fb_fr_invites_desc: "У вас {count} приглашений. С помощью каждого из них можно пригласить одного друга.", fr_fr_invite_confirm: "Пригласить {name} в качестве друга?", fb_fr_invite_fb_header: "Пригласить из Facebook", fb_fr_invite_success: "Друг был добавлен в ваш список", fb_fr_invite_send: "Приглашение отправлено", fb_fr_invite_af: "Этот бог уже есть в списке ваших друзей", fb_fr_invite_ni: "Извините, но у вас больше нет приглашений", fb_fr_invite_error: "Ошибка отправки приглашения. Пожалуйста, повторите запрос позднее", fb_health_title: "", fb_inv_title: "", fb_gold_title: "", fb_friends_title: "", fb_panth_title: "", fb_icon_inv_title: "Инвентарь геро{я|ини}", fb_icon_equip_title: "Снаряжение геро{я|ини}", fb_icon_skills_title: "Умения геро{я|ини}", fb_icon_pet_title: "Питомец геро{я|ини}", fb_opp_wl: "число побед/поражений противника", fb_opp_h: "текущее и максимальное число очков здоровья противника", fb_opp_i: "текущая и максимальная вместительность инвентаря противника", fb_opp_g: "число монет у противника", fb_opp_more: "Дополнительная информация о противнике", fr_god_m: "бог", fr_god_f: "богиня", fr_god_m_link: "его", fr_god_f_link: "её", fr_hero_m: "герой", fr_hero_f: "героиня", fr_chat_title: "{god_name} и {god_link} {hero_name}", fr_link_badge_title: "Число новых сообщений от друзей", fr_gch_link: "Гильдсовет", fr_gch_link_badge_title: "Число новых сообщений в гильдсовете", fr_gch_w_title: "Совет гильдии «{guild}»", fr_gch_close_title: "Закрыть окно", fr_gch_no_messages: "Сообщения отсутствуют.", fr_chat_ban_link: "Изгнать бога из гильдсовета", fr_chat_ban_confirm: "Вы уверены, что {god} должен быть изгнан из гильдсовета?", fr_chat_banned_link: "Показать список изгнанных богов", fr_chat_banned: "Изгнанные боги", fr_chat_banned_empty: "Доступ к гильдсовету разрешен всем участникам гильдии.", fr_chat_name: "Подставить имя", fr_chat_banned_god: "Бог", fr_chat_banned_hero: "Герой", fr_chat_banned_rank: "Звание", fr_chat_banned_action: "Действие", fr_chat_unban: "вернуть обратно", fr_chat_unban_confirm: "Снять запрет доступа для {god}?", fr_chat_wr_unavail: "Звание вашего героя слишком мало для участия в гильдсовете.", themes_capt: "Цветовая схема:", th_classic: "основная", th_retro: "ретро", th_blue: "небесная", th_white: "белая", th_pink: "гламурная", th_yellow: "солнечная", th_emerald: "изумрудная", th_violet: "сиреневая", th_nightly: "ночная", am_pm_capt: "Формат времени", am_pm_12h: "AM/PM", am_pm_24h: "24 часа", ps_capt: "Настройки страницы", ps_appearance_capt: "Внешний вид", ps_options_capt: "Параметры", ps_turbo_msg: "Турбо-режим", ps_theme_capt: "Цветовое оформление", ps_make_default: "Открывать эту страницу героя по умолчанию", ps_reset_settings: "Вернуть cтандартные настройки страницы", ps_reset_settings_note: "(может помочь в случае ошибок или проблем)", ps_reset_settings_q: "Вы действительно хотите вернуть стандартные настройки для этой страницы?", ps_disable_sharing: "Отключить панель цитирования в социальные сети", ps_discuss: "<a href='/forums/show_topic/2067' target='_blank'>Обсудить</a> страницу героя на форуме", ps_gp_confirm_thre: "Подтверждать распаковку заряда, если праны больше:", ps_ns_themes: "не поддерживается в данном браузере", restore_columns_capt: "Число колонок:", restore_columns3: "3 колонки", restore_columns5: "5 колонок", ps_footer: "(актуальны только для вашего текущего браузера)", ps_turbo_note: "(при проблемах с ним посмотрите <a href='/forums/show_topic/593' target='_blank'>эту тему</a>)", ps_notif_capt: "Уведомления", ps_notif_unavailable: "Уведомления работают только в браузерах Google Chrome, Safari 6 и Firefox 22.", ps_notif_death: "Смерть героя", ps_notif_death_d: "Показывать уведомление, когда герой погибает.", ps_notif_mquest: "Взятие мини-квеста", ps_notif_mquest_d: "Показывать уведомление, когда герой получает мини-квест.", ps_notif_quest: "Завершение задания", ps_notif_quest_d: "Показывать уведомление, когда герой завершает задание.", ps_notif_levelup: "Новый уровень", ps_notif_levelup_d: "Показывать уведомление, когда герой получает новый уровень.", ps_notif_duel: "Начало дуэли", ps_notif_duel_d: "Показывать уведомление, когда герой вступает в дуэль с опасным противником.", ps_notif_sa: "Активируемый трофей", ps_notif_sa_d: "Показывать уведомление, когда герой находит активируемый предмет.", ps_notif_return_town: "Возвращение в город", ps_notif_return_town_d: "Показывать уведомление, когда герой возвращается в город.", ps_notif_invite: "Инвайт на Годвилль", ps_notif_invite_d: "Показывать уведомление, когда герой находит инвайт и может пригласить друга.", ps_notif_fr_msg: "Сообщения от друзей", ps_notif_fr_msg_d: "Показывать уведомления о получении нового сообщения от друга, когда вкладка браузера неактивна.", ps_notif_test: "Показать тестовое уведомление", ps_notif_test_d: "Если уведомление не показывается в Google Chrome, проверьте исключения в настройках браузера ('Настройки' -> 'Расширенные' -> 'Настройки содержания' -> 'Оповещения, Управление исключениями'). Для Firefox проверьте настройки или попробуйте перезапустить браузер.", dn_test: "Это тестовое уведомление.", dn_duel: "Геро{й|иня} вступил{|а} в дуэль!", dn_dungeon: "Геро{й|иня} вош{ел|ла} в подземелье!", dn_death: "Геро{й|иня} скончал{ся|ась} от ранений.", dn_mquest: "Геро{й|иня} отправил{ся|ась} в мини-квест!", dn_quest: "Геро{й|иня} успешно завершил{|а} задание.", dn_return_town: "Геро{й|иня} приш{ел|ла} в город {town_name}.", dn_levelup: "Геро{й|иня} получил{|а} новый уровень.", dn_sa: "Геро{й|иня} наш{ел|ла} {item_name}.", dn_invite: "Геро{й|иня} наш{ел|ла} инвайт на Годвилль.", dn_fr_msg: "Новое сообщение от друга.", dn_invite_name: "инвайт на Годвилль", old_br_intro: "К сожалению, основная страница героя отказывается работать в вашем браузере. Рекомендуем пользоваться последними версиями одного из этих браузеров:", old_br_footer: "Если подходящего браузера у вас нет, вы можете воспользоваться <a href='/hero'> устаревшей страницей героя</a>.", old_br_footer_fb: "Если подходящего браузера у вас нет, вы можете открыть <a href='/hero' target='blank'>эту</a> устаревшую страницу героя.", old_br_footer_reset: "Если же раньше в этом браузере страница работала, попробуйте отключить его расширения (плагины) или ", old_br_footer_reset_link: "сбросить настройки страницы.", old_br_no_jq: "Ошибка загрузки jQuery. Пожалуйста, убедитесь, что в браузере разрешена загрузка скриптов с домена http://code.jquery.com (она может блокироваться расширениями и аддонами типа NoScript и AdBlock, антивирусами или прокси).", webgl_ns: "Для работы 3D необходим браузер с поддержкой WebGL.", webgl_nk_link: "Обновить браузер", webgl_ns_other: "Похоже, что WebGL не поддерживается на вашем компьютере.", webgl_ns_other_link: "Дополнительная информация.", fbs_share_title: "Отправить в Facebook", twt_share_title: "Отправить в Twitter", vk_share_title: "Отправить во Вконтакте", vk_share_warn: "Совет: чтобы ВКонтакт не обрезал сообщение в ленте, скопируйте текст фразы в поле комментария.", fbs_capt: "Город богов и героев", twit_tag: "годвилль", set_motto_placeholder: "Введите девиз", set_motto_title: "Изменить девиз геро{я|ини}", set_motto_save_title: "Сохранить девиз", set_motto_cancel_title: "Отменить изменения", set_motto_error_len: "Сожалеем, но девиз не может быть длиннее 25 символов.", set_motto_error: "Ошибка установки девиза. Проверьте ваш девиз и попробуйте еще раз.", imp_e_title: "Показать важнейшие события из жизни {героя|героини}", imp_e_capt: "Третий глаз", d_today: "Сегодня", d_yesterday: "Вчера", d_2days_ago: "Позавчера", d_3_4days_ago: "{days} дня назад", d_xdays_ago: "{days} дней назад", d_ago_s: "{x}с", d_ago_m: "{x}м", d_ago_h: "{x}ч", d_ago_d: "{x}д", new_ach_title: "Новая заслуга", new_ach_title_t: 'Новая заслуга — "{title}"', ach_title1: "1-й степени", ach_title2: "2-й степени", ach_title3: "3-й степени", ach_title: "{title} {rank}", ach_fb_sh: "", ach_fb_share: "рассказать друзьям", miniq: "(мини)", h_search_default: "Ищем героя на кладбищах погибших серверов...", pr_level: "уровень — {prct}", pr_quest: "задание — {prct}", pr_news: "прогресс — {prct}", pr_inv: "инвентарь — {prct}", pr_hp: "здоровье — {prct}", pr_gp: "прана — {prct}", pr_duel: "прогресс хода — {prct}", map_legend: "легенда", map_legend_pos: "@ - герои", map_legend_exit: "В - выход", map_legend_wall: "# - стена", map_legend_unknown: "? - неизвестно", duel_switch_confirm: "Для продолжения странице нужно перезагрузиться. Вы готовы?", uph_author: "Автор фразы - {author}", last_record: ""}, load_failed_timer, alreadyrunflag = 0;
...
window.onload = function () {
  ...
  jQuery("#noJS").remove(), $("#menu_bar").hide(), load_failed_timer = window.setTimeout(function () {
    var a = $("#hero_block"), b = $('<table  style="text-align:center;width:760px;" align=center></table>'), c = [
      {n: "Google Chrome", i: "/images/br_chrome.png", d: "http://www.google.com/chrome"},
      {n: "Apple Safari", i: "/images/br_safari.png", d: "http://www.apple.com/safari"},
      {n: "Mozilla Firefox", i: "/images/br_ff.png", d: "http://www.mozilla.com/firefox"},
  ...
  function l(b, c, d) {
    if ((c.empty || d) && b == null)return null;
    if (c.def && b == null)return c.def;
    c.type === "int" && (b = ~~b), c.mod && (b = (b < 0 ? b + c.mod * (1 + ~~(-b / c.mod)) : b) % c.mod), c.type === "float" && (b = parseFloat(b)), a.isNaN(b) && (b = c.def);
    return c.min > b ? c.min : c.max < b ? c.max : b
  }

  var c = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color outlineColor".split(" "), d = /^([\-+])=\s*(\d+\.?\d*)/, e = [
  ...
  }, g = {rgba: {cache: "_rgba", props: {red: {idx: 0, min: 0, max: 255, type: "int", empty: !0}, green: {idx: 1, min: 0, max: 255, type: "int", empty: !0}, blue: {idx: 2, min: 0, max: 255, type: "int", empty: !0}, alpha: {idx: 3, min: 0, max: 1, type: "float", def: 1}}}, hsla: {cache: "_hsla", props: {hue: {idx: 0, mod: 360, type: "int", empty: !0}, saturation: {idx: 1, min: 0, max: 1, type: "float", empty: !0}, lightness: {idx: 2, min: 0, max: 1, type: "float", empty: !0}}}}, h = g.rgba.props, i = f.support = {}, j, k = a.each;
  g.hsla.props.alpha = h.alpha, f.fn = f.prototype = {constructor: f, parse: function (c, d, i, m) {
    if (c === b) {
      this._rgba = [null, null, null, null];
      return this
    }
    if (c instanceof a || c.nodeType)c = c instanceof a ? c.css(d) : a(c).css(d), d = b;
    var n = this, o = a.type(c), p = this._rgba = [], q;
    d !== b && (c = [c, d, i, m], o = "array");
    if (o === "string") {
      c = c.toLowerCase(), k(e, function (a, b) {
        var d = b.re.exec(c), e = d && b.parse(d), f, h = b.space || "rgba", i = g[h].cache;
        if (e) {
          f = n[h](e), h != "rgba" && (n[i] = f[i]), p = n._rgba = f._rgba;
          return!1
        }
      });
      if (p.length !== 0) {
        Math.max.apply(Math, p) === 0 && $.extend(p, j.transparent);
        return this
      }
      c = j[c] || j._default;
      return this.parse(c)
    ...
    if (o === "object") {
      c instanceof f ? k(g, function (a, b) {
        c[b.cache] && (n[b.cache] = c[b.cache].slice())
      }) : k(g, function (a, b) {
        k(b.props, function (a, d) {
          var e = b.cache;
          if (!n[e] && b.to) {
            if (c[a] == null || a === "alpha")return;
            n[e] = b.to(n._rgba)
          }
          n[e][d.idx] = l(c[a], d, !0)
        })
    ...
    k(g, function (a, e) {
      var f = b[e.cache], g;
      f && (g = d[e.cache] || e.to && e.to(d._rgba) || [], k(e.props, function (a, b) {
        if (f[b.idx] != null) {
          c = f[b.idx] == g[b.idx];
          return c
        }
    ...
    var c = f(a), d = c._space(), e = g[d], h = this[e.cache] || e.to(this._rgba), i = h.slice();
    c = c[e.cache], k(e.props, function (a, d) {
      var e = h[d.idx], f = c[d.idx];
      f !== null && (e === null ? i[d.idx] = f : (d.mod && (f - e > d.mod / 2 ? e += d.mod : e - f > d.mod / 2 && (e -= d.mod)), i[d.idx] = l((f - e) * b + e, d)))
    });
    return this[d](i)
  }, blend: function (b) {
    ...
    var b = a.map(this._rgba, function (a, b) {
      return a == null ? b > 2 ? 1 : 0 : a
    });
    b[3] === 1 && (b.length = 3);
    return(b.length === 3 ? "rgb(" : "rgba(") + b.join(",") + ")"
  }, toHslaString: function () {
    var b = a.map(this.hsla(), function (a, b) {
      a = a == null ? b > 2 ? 1 : 0 : a;
      if (b === 1 || b === 2)a = Math.round(a * 100) + "%";
      return a
    });
    b[3] === 1 && (b.length = 3);
    return(b.length === 3 ? "hsl(" : "hsla(") + b.join(",") + ")"
  }, toHexString: function (b) {
    var c = this._rgba.slice();
    b || (c.length = 3);
    return"#" + a.map(c,function (a, b) {
      var c = b === 3 ? 255 : 1, d = (a * c).toString(16);
    ...
    g === f ? k = 0 : b === f ? k = 60 * (c - d) / h + 360 : c === f ? k = 60 * (d - b) / h + 120 : k = 60 * (b - c) / h + 240, j === 0 || j === 1 ? l = j : j <= .5 ? l = h / i : l = h / (2 - i);
    ...
    return[Math.round(m(g, f, b + 1 / 3) * 255), Math.round(m(g, f, b) * 255), Math.round(m(g, f, b - 1 / 3) * 255), e]
  }, k(g, function (c, e) {
    var g = e.props, h = e.cache, i = e.to, j = e.from;
    f.fn[c] = function (c) {
      i && !this[h] && (this[h] = i(this._rgba));
      if (c === b)return this[h].slice();
      var d = a.type(c), e = d === "array" || d === "object" ? c : arguments, m = this[h].slice(), n;
      k(g, function (a, b) {
        var c = e[d === "object" ? a : b.idx];
        c == null && (c = m[b.idx]), m[b.idx] = l(c, b)
      });
      if (j) {
        n = f(j(m)), n[h] = m;
        return n
    ...
    a.cssHooks[c] = {set: function (b, d) {
      ...
      if (!i.rgba && d._rgba[3] !== 1) {
        var e = c === "backgroundColor" ? b.parentNode : b, g;
        do {
          g = a.curCSS(e, "backgroundColor");
          if (g !== "" && g !== "transparent")break
        } while ((b = b.parentNode) && b.style);
        d = d.blend(f(g || "_default"))
      }
      d = d.toRgbaString(), b.style && (b.style[c] = d)
    ...
    b.cssText = "background-color:rgba(150,255,150,.5)", i.rgba = b.backgroundColor.indexOf("rgba") > -1
  }), j = a.Color.names = {aqua: "#00ffff", azure: "#f0ffff", beige: "#f5f5dc", black: "#000000", blue: "#0000ff", brown: "#a52a2a", cyan: "#00ffff", darkblue: "#00008b", darkcyan: "#008b8b", darkgrey: "#a9a9a9", darkgreen: "#006400", darkkhaki: "#bdb76b", darkmagenta: "#8b008b", darkolivegreen: "#556b2f", darkorange: "#ff8c00", darkorchid: "#9932cc", darkred: "#8b0000", darksalmon: "#e9967a", darkviolet: "#9400d3", fuchsia: "#ff00ff", gold: "#ffd700", green: "#008000", indigo: "#4b0082", khaki: "#f0e68c", lightblue: "#add8e6", lightcyan: "#e0ffff", lightgreen: "#90ee90", lightgrey: "#d3d3d3", lightpink: "#ffb6c1", lightyellow: "#ffffe0", lime: "#00ff00", magenta: "#ff00ff", maroon: "#800000", navy: "#000080", olive: "#808000", orange: "#ffa500", pink: "#ffc0cb", purple: "#800080", violet: "#800080", red: "#ff0000", silver: "#c0c0c0", white: "#ffffff", yellow: "#ffff00", transparent: [null, null, null, 0], _default: "#ffffff"}
}(jQuery), function (a) {
  a.fn.glow = function () {
    function j(b, c) {
      function d() {
  ...
  a.widget("ui.mouse", {options: {cancel: ":input,option", distance: 1, delay: 0}, _mouseInit: function () {
    ...
    this.element.bind("mousedown." + this.widgetName,function (a) {
      ...
      if (!0 === a.data(d.target, c.widgetName + ".preventClickEvent")) {
        a.removeData(d.target, c.widgetName + ".preventClickEvent"), d.stopImmediatePropagation();
        return!1
      }
    }), this.started = !1
    ...
    if (!c.originalEvent.mouseHandled) {
      ...
      var d = this, e = c.which == 1, f = typeof this.options.cancel == "string" ? a(c.target).parents().add(c.target).filter(this.options.cancel).length : !1;
      if (!e || f || !this._mouseCapture(c))return!0;
      ...
      !0 === a.data(c.target, this.widgetName + ".preventClickEvent") && a.removeData(c.target, this.widgetName + ".preventClickEvent"), this._mouseMoveDelegate = function (a) {
        return d._mouseMove(a)
      }, this._mouseUpDelegate = function (a) {
        return d._mouseUp(a)
      }, a(document).bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate), c.preventDefault();
    ...
    this._mouseDistanceMet(c) && this._mouseDelayMet(c) && ((this._mouseStarted = this._mouseStart(this._mouseDownEvent, c) !== !1) ? this._mouseDrag(c) : this._mouseUp(c));
    return!this._mouseStarted
  }, _mouseUp: function (c) {
    a(document).unbind("mousemove." + this.widgetName, this._mouseMoveDelegate).unbind("mouseup." + this.widgetName, this._mouseUpDelegate), this._mouseStarted && (this._mouseStarted = !1, c.target == this._mouseDownEvent.target && a.data(c.target, this.widgetName + ".preventClickEvent", !0), this._mouseStop(c));
    return!1
  ...
  a.widget("ui.draggable", a.ui.mouse, {widgetEventPrefix: "drag", options: {addClasses: !0, appendTo: "parent", axis: !1, connectToSortable: !1, containment: !1, cursor: "auto", cursorAt: !1, grid: !1, handle: !1, helper: "original", iframeFix: !1, opacity: !1, refreshPositions: !1, revert: !1, revertDuration: 500, scope: "default", scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, snap: !1, snapMode: "both", snapTolerance: 20, stack: !1, zIndex: !1}, _create: function () {
    ...
    var c = this.options;
    if (this.helper ||
      c.disabled || a(b.target).is(".ui-resizable-handle"))return!1;
  ...
  }}), a.extend(a.ui.draggable, {version: "1.8.11"}), a.ui.plugin.add("draggable", "connectToSortable", {start: function (b, c) {
    var e = a(this).data("draggable"), f = e.options, g = a.extend({}, c, {item: e.element});
    e.sortables = [], a(f.connectToSortable).each(function () {
      var c = a.data(this, "sortable");
      c && !c.options.disabled && (e.sortables.push({instance: c, shouldRevert: c.options.revert}), c.refreshPositions(), c._trigger("activate", b, g))
    })
  }, stop: function (b, c) {
  ...
  a.widget("ui.droppable", {widgetEventPrefix: "drop", options: {accept: "*", activeClass: !1, addClasses: !0, greedy: !1, hoverClass: !1, scope: "default", tolerance: "intersect"}, _create: function () {
  ...
  }}), a.extend(a.ui.droppable, {version: "1.8.11"}), a.ui.intersect = function (b, c, e) {
    ...
    a:for (; h < e.length; h++)if (!(e[h].options.disabled || b && !e[h].accept.call(e[h].element[0], b.currentItem || b.element))) {
      ...
      e[h].visible = e[h].element.css("display") != "none", e[h].visible && (f == "mousedown" && e[h]._activate.call(e[h], c), e[h].offset = e[h].element.offset(), e[h].proportions = {width: e[h].element[0].offsetWidth, height: e[h].element[0].offsetHeight})
    }
  }, drop: function (b, c) {
    var e = !1;
  ...
  a.widget("ui.resizable", a.ui.mouse, {widgetEventPrefix: "resize", options: {alsoResize: !1, animate: !1, animateDuration: "slow", animateEasing: "swing", aspectRatio: !1, autoHide: !1, containment: !1, ghost: !1, grid: !1, handles: "e,s,se", helper: !1, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 1e3}, _create: function () {
    ...
    if (this.handles.constructor == String) {
      ...
      for (var f = 0; f < d.length; f++) {
        ...
        /sw|se|ne|nw/.test(g) && h.css({zIndex: ++c.zIndex}), "se" == g && h.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[g] = ".ui-resizable-" + g, this.element.append(h)
      }
    }
    this._renderAxis = function (b) {
      ...
      for (var c in this.handles) {
        ...
        if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
          ...
          f = /sw|ne|nw|se|n|s/.test(c) ? d.outerHeight() : d.outerWidth(), d = ["padding", /ne|nw|n/.test(c) ? "Top" : /se|sw|s/.test(c) ? "Bottom" : /^e$/.test(c) ? "Right" : "Left"].join(""), b.css(d, f), this._proportionallyResize()
        }
        a(this.handles[c])
      }
    ...
    c = this._respectSize(c, a), this._propagate("resize", a), b.css({top: this.position.top + "px", left: this.position.left + "px", width: this.size.width + "px", height: this.size.height + "px"}), !this._helper && this._proportionallyResizeElements.length && this._proportionallyResize(), this._updateCache(c), this._trigger("resize", a, this.ui());
    return!1
  }, _mouseStop: function (b) {
    this.resizing = !1;
    ...
    if (this._helper) {
      ...
      f = g && a.ui.hasScroll(f[0], "left") ? 0 : d.sizeDiff.height, g = g ? 0 : d.sizeDiff.width, g = {width: d.helper.width() - g, height: d.helper.height() - f}, f = parseInt(d.element.css("left"), 10) + (d.position.left - d.originalPosition.left) || null;
      var h = parseInt(d.element.css("top"), 10) + (d.position.top - d.originalPosition.top) || null;
      c.animate || this.element.css(a.extend(g, {top: h, left: f})), d.helper.height(d.size.height), d.helper.width(d.size.width), this._helper && !c.animate && this._proportionallyResize()
    }
    ...
    a.height ? a.width = c.height * this.aspectRatio : a.width && (a.height = c.width / this.aspectRatio), d == "sw" && (a.left = b.left + (c.width - a.width), a.top = null), d == "nw" && (a.top = b.top + (c.height - a.height), a.left = b.left + (c.width - a.width));
    return a
  }, _respectSize: function (a) {
    var b = this.options, d = this.axis, e = c(a.width) && b.maxWidth && b.maxWidth < a.width, f = c(a.height) && b.maxHeight && b.maxHeight < a.height, g = c(a.width) && b.minWidth && b.minWidth > a.width, h = c(a.height) && b.minHeight && b.minHeight > a.height;
    g && (a.width = b.minWidth), h && (a.height = b.minHeight), e && (a.width = b.maxWidth), f && (a.height = b.maxHeight);
    var i = this.originalPosition.left + this.originalSize.width, j = this.position.top + this.size.height, k = /sw|nw|w/.test(d);
    d = /nw|ne|n/.test(d), g && k && (a.left = i - b.minWidth), e && k && (a.left = i - b.maxWidth), h && d && (a.top = j - b.minHeight), f && d && (a.top = j - b.maxHeight), (b = !a.width && !a.height) && !a.left && a.top ? a.top = null : b && !a.top && a.left && (a.left = null);
    return a
    ...
    if (this._proportionallyResizeElements.length)for (var b = this.helper || this.element, c = 0; c < this._proportionallyResizeElements.length; c++) {
      ...
      if (!this.borderDif) {
        ...
        this.borderDif = a.map(f, function (a, b) {
          a = parseInt(a, 10) || 0, b = parseInt(g[b], 10) || 0;
          return a + b
        })
      }
    ...
    if (this._helper) {
      ...
      c = c ? 2 : -1, this.helper.addClass(this._helper).css({width: this.element.outerWidth() + c, height: this.element.outerHeight() + c, position: "absolute", left: this.elementOffset.left - d + "px", top: this.elementOffset.top - d + "px", zIndex: ++b.zIndex}), this.helper.appendTo("body").disableSelection()
  ...
  }}), a.extend(a.ui.resizable, {version: "1.8.11"}), a.ui.plugin.add("resizable", "alsoResize", {start: function () {
    ...
    typeof b.alsoResize == "object" && !b.alsoResize.parentNode ? b.alsoResize.length ? (b.alsoResize = b.alsoResize[0], c(b.alsoResize)) : a.each(b.alsoResize, function (a) {
      c(a)
    }) : c(b.alsoResize)
  }, resize: function (b, c) {
    ...
    var f = d.originalSize, g = d.originalPosition, h = {height: d.size.height - f.height || 0, width: d.size.width - f.width || 0, top: d.position.top - g.top || 0, left: d.position.left - g.left || 0}, i = function (b, f) {
      a(b).each(function () {
        ...
        a.each(k, function (a, b) {
          (a = (g[b] || 0) + (h[b] || 0)) && a >= 0 && (i[b] = a || null)
        }), a.browser.opera && /relative/.test(b.css("position")) && (d._revertToRelativePosition = !0, b.css({position: "absolute", top: "auto", left: "auto"})), b.css(i)
      })
    };
    ...
    b._revertToRelativePosition && (b._revertToRelativePosition = !1, typeof c.alsoResize == "object" && !c.alsoResize.nodeType ? a.each(c.alsoResize, function (a) {
      d(a)
    }) : d(c.alsoResize)), a(this).removeData("resizable-alsoresize")
    ...
    g = {width: c.size.width - (g ? 0 : c.sizeDiff.width), height: c.size.height - h}, h = parseInt(c.element.css("left"), 10) + (c.position.left - c.originalPosition.left) || null;
    ...
    c.element.animate(a.extend(g, i && h ? {top: i, left: h} : {}), {duration: d.animateDuration, easing: d.animateEasing, step: function () {
      ...
      f && f.length && a(f[0]).css({width: d.width, height: d.height}), c._updateCache(d), c._propagate("resize", b)
    }})
    ...
    if (d = f instanceof a ? f.get(0) : /parent/.test(f) ? d.parent().get(0) : f) {
      ...
      if (/document/.test(f) || f == document)c.containerOffset = {left: 0, top: 0}, c.containerPosition = {left: 0, top: 0}, c.parentData = {element: a(document), left: 0, top: 0, width: a(document).width(), height: a(document).height() || document.body.parentNode.scrollHeight}; else {
        var g = a(d), h = [];
        a(["Top", "Right", "Left", "Bottom"]).each(function (a, c) {
          h[a] = b(g.css("padding" + c))
        }), c.containerOffset = g.offset(), c.containerPosition = g.position(), c.containerSize = {height: g.innerHeight() - h[3], width: g.innerWidth() - h[1]}, f = c.containerOffset;
        var i = c.containerSize.height, j = c.containerSize.width;
        j = a.ui.hasScroll(d, "left") ? d.scrollWidth : j, i = a.ui.hasScroll(d) ? d.scrollHeight : i, c.parentData = {element: d, left: f.left, top: f.top, width: j, height: i}
      }
    }
  }, resize: function (b) {
    ...
    h = h.outerHeight() - b.sizeDiff.height, b._helper && !c.animate && /relative/.test(g.css("position")) && a(this).css({left: i.left - f.left - d.left, width: j, height: h}), b._helper && !c.animate && /static/.test(g.css("position")) && a(this).css({left: i.left - f.left - d.left, width: j, height: h})
  }}), a.ui.plugin.add("resizable", "ghost", {start: function () {
    var b = a(this).data("resizable"), c = b.options, d = b.size;
    b.ghost = b.originalElement.clone(), b.ghost.css({opacity: .25, display: "block", position: "relative", height: d.height, width: d.width, margin: 0, left: 0, top: 0}).addClass("ui-resizable-ghost").addClass(typeof c.ghost == "string" ? c.ghost : ""), b.ghost.appendTo(b.helper)
  }, resize: function () {
  ...
  a.widget("ui.sortable", a.ui.mouse, {widgetEventPrefix: "sort", options: {appendTo: "parent", axis: !1, connectWith: !1, containment: !1, cursor: "auto", cursorAt: !1, dropOnEmpty: !0, forcePlaceholderSize: !1, forceHelperSize: !1, grid: !1, handle: !1, helper: "original", items: "> *", opacity: !1, placeholder: !1, revert: !1, scroll: !0, scrollSensitivity: 20, scrollSpeed: 20, scope: "default", tolerance: "intersect", zIndex: 1e3}, _create: function () {
    this.containerCache = {}, this.element.addClass("ui-sortable"), this.refresh(), this.floating = this.items.length ? /left|right/.test(this.items[0].item.css("float")) || /inline|table-cell/.test(this.items[0].item.css("display")) : !1, this.offset = this.element.offset(), this._mouseInit()
  }, destroy: function () {
    ...
    a.ui.ddmanager && (a.ui.ddmanager.current = this), a.ui.ddmanager && !c.dropBehaviour && a.ui.ddmanager.prepareOffsets(this, b), this.dragging = !0, this.helper.addClass("ui-sortable-helper"), this._mouseDrag(b);
    return!0
  }, _mouseDrag: function (b) {
    this.position = this._generatePosition(b), this.positionAbs = this._convertPositionTo("absolute"), this.lastPositionAbs || (this.lastPositionAbs = this.positionAbs);
    if (this.options.scroll) {
      var c = this.options, e = !1;
    ...
    for (g = e.length - 1; g >= 0; g--) {
      b = e[g][1], f = e[g][0], i = 0;
      for (h = f.length; i < h; i++)j = a(f[i]), j.data("sortable-item", b), c.push({item: j, instance: b, width: 0, height: 0, left: 0, top: 0})
    }
  }, refreshPositions: function (b) {
    this.offsetParent && this.helper && (this.offset.parent = this._getParentOffset());
    for (var c = this.items.length - 1; c >= 0; c--) {
      var e = this.items[c], f = this.options.toleranceElement ? a(this.options.toleranceElement, e.item) : e.item;
    ...
    if (c)if (this.containers.length === 1)this.containers[e]._trigger("over", b, this._uiHash(this)), this.containers[e].containerCache.over = 1; else if (this.currentContainer != this.containers[e]) {
      c = 1e4, f = null;
  ...
  a.fn.popover = function (b) {
    var c = {openEvent: null, closeEvent: null, offsetX: 0, offsetY: 0}, b = a.extend(c, b), d = a(b.header).detach(), e = a(b.content).detach(), f = a('<div class="popover"><div class="triangle"></div><div class="header"></div><div class="content"></div></div>').appendTo("body");
    a(".header", f).append(d), a(".content", f).append(e), a.fn.popover.openedPopup && a.fn.popover.openedPopup.trigger("hidePopover"), a.fn.popover.openedPopup = null, a(document).bind("click", function (b) {
    ...
    var g = function (c) {
      ...
      f.css("display", "block");
      var e = 0, g = 0, h = a(document).width(), i = a(document).height(), j = parseInt(d.css("border-bottom-width")), k = f.outerWidth(), l = f.outerHeight(), m = c.outerWidth(), n = c.outerHeight(), o = c.offset();
      g = o.top + n + j;
      var p = i - (g + l + j), q = 18;
      e = o.left + (m - k) / 2;
      var r = 0;
      e < q ? r = e - q : e + k > h && (r = e + k - h + q), d.css("right", k / 2 - j + r), f.offset({top: g + b.offsetY, left: e - r + b.offsetX}), f.show(), window.setTimeout(function () {
...
var Gcv = {_keyStr: "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", encode: function (a) {
...
var keys_to_n = {exp_progress: "level", max_health: "health", inventory_max_num: "inventory_num", quest_progress: "quest", quests_completed: "quest", win_lost: ["arena_won", "arena_lost"], temple_completed_at: "bricks_cnt", health: "control", dir: "distance", c_town: "distance", godpower: ["control", "inventory"], monster_name: "news", monster_progress: "news", s_progress: "news", town_name: "distance", aura_time: "aura_name", diary: "control", is_arena_disabled: "control", is_arena_available: "control", chfr_after: "control", arena_send_after: "control", arena_god_cmd_disabled: "control", arena_fight: "control", accumulator: "control", arena_cmd_left: "control", clan_position: "clan", pet: ["pet_birthday_string", "pet_level", "pet_class", "pet_is_dead", "pet_is_dead_str", "pet_name", "pet_special"], pet_is_dead: "pet_is_dead_str", m_fight_log: ["control", "turn_progress"]};
NM.prototype.register = function (a, b) {
  ...
  gv_log(a), $.post(base_api_url, {a: get_cmd_id("Bja2XQ1F4t9uo9YNkrTH"), b: prepare_args(JSON.stringify(a))}, function (a) {
  ...
  if (d && b[d].title && b[d].desc && b[d].title.length > 0 && b[d].desc.length > 0) {
    ...
    e && (f = e);
    var g;
    f != "" ? g = localize(Loc.ach_title, {title: b[d].title, rank: f}) : g = b[d].title, $("#ach_capt").html(localize(Loc.new_ach_title_t, {title: g})), $("#ach_content").empty(), $("#ach_content").append($('<div class="ach_l"</div>>').html(b[d].desc));
    var h = $("#ach_c");
    h.unbind("click"), h.addClass("div_link"), h.html(Loc.hint_close);
    var i = this;
    h.click(function (a) {
      $.post(base_api_url, {a: get_cmd_id("dg3yOKCzGwdKvsTOtdt4"), b: prepare_args(JSON.stringify({ids: [d].concat(c)}))}, function (a) {
        a && a.status == "success" && ($("#ach_bar").slideUp(), this.messages = {})
      })
    });
    if (window.fbe && Loc.locale == "en") {
      var j = $("#ach_tf");
      j.unbind("click"), j.addClass("div_link"), j.html(Loc.ach_fb_share), j.click(HFB.diary_click_f(localize(Loc.ach_fb_sh, {rank: e, title: b[d].title})))
    }
    $("#ach_bar").slideDown()
  }
  ...
  k.unbind("click"), k.click(function (b) {
    var d = a.concat(c);
    $.post(base_api_url, {a: get_cmd_id("dg3yOKCzGwdKvsTOtdt4"), b: prepare_args(JSON.stringify({ids: d}))}, function (a) {
  ...
  var f = {sk5_2: ["sk5"], sk5_3: ["sk5", "sk5_2"], sk5_4: ["sk5", "sk5_2", "sk5_3"], a10_2: ["a10"], a10_3: ["a10", "a10_2"], evilm_2: ["evilm"], evilm_3: ["evilm", "evilm_2"], evilm_4: ["evilm", "evilm_2", "evilm_3"], goodm_2: ["goodm"], goodm_3: ["goodm", "goodm_2"], goodm_4: ["goodm", "goodm_2", "goodm_3"], gcard_2: ["gcard"], gcard_3: ["gcard", "gcard_2"], tmpl: ["tmpl_2", "tmpl_3"], tmpl_2: ["tmpl_3"], pet: ["pet_2", "pet_3"], pet_2: ["pet_3"], absnt_2: ["absnt"], absnt_3: ["absnt", "absnt_2"], absnt_4: ["absnt", "absnt_2", "absnt_3"], reglr_2: ["reglr"], reglr_3: ["reglr", "reglr_2"], reglr_4: ["reglr", "reglr_2", "reglr_3"], train_2: ["train"], train_3: ["train", "train_2"], dth_2: ["dth"], dth_3: ["dth", "dth_2"], dth_4: ["dth", "dth_2", "dth_3"], lfght_2: ["lfght"], lfght_3: ["lfght", "lfght_2"], dgn_2: ["dgn"], dgn_3: ["dgn", "dgn_2"], bmk_2: ["bmk"], bmk_3: ["bmk", "bmk_2"], bmk_4: ["bmk", "bmk_2", "bmk_3"]}, g = {};
  for (var e in a) {
    var h = a[e];
  ...
  var b = this;
  this.messages[a] == undefined ? $.post(base_api_url, {a: get_cmd_id("KztXWDej9YxdBu0LCMUf"), b: prepare_args(JSON.stringify({name: a}))}, function (c) {
  ...
  var c = this;
  $.post(base_api_url, {a: get_cmd_id("KztXWDej9YxdBu0LCMUf"), b: prepare_args(JSON.stringify({name: a, page: b}))}, function (d) {
  ...
  if (this.guild_messages[a] == undefined || c.new_gc_m_id != b) {
    var d = {guild: a};
    b && (d.sid = b), this.gc_ext_perms == undefined && (d.perms = "1"), $.post(base_api_url, {a: get_cmd_id("nYrBGlddZVxNgxJLFffQ"), b: prepare_args(JSON.stringify(d))}, function (b) {
  ...
  for (var c in a) {
    var d = a[c];
    this.pantheons["group" + c] == undefined ? (this.pantheons["group" + c] = {name: d.group_name, data: []}, this.old_pantheons["group" + c] = {name: d.group_name, data: []}, this.group_cnt += 1, b = !0) : this.old_pantheons["group" + c] == undefined && (this.old_pantheons["group" + c] = {name: d.group_name, data: []}, b = !0);
  ...
  if (supports_local_storage()) {
    a && a < 13 && this.add_default(), b ? c == "dungeon" ?
      arr = this.vdata_d : arr = this.vdata_a : arr = this.vdata;
    return arr
  }
  return null
};
...
Date.prototype.setISO8601 = function (a) {
  ...
  return"textOverflow"in b || "OTextOverflow"in b ? this : this.each(function () {
    ...
    if (b && b.css("overflow") == "hidden") {
      var c = b.html(), d = b.width(), e = $(this.cloneNode(!0)).hide().css({position: "absolute", width: "auto", overflow: "visible", "max-width": "inherit"});
      b.after(e);
      var f = c;
  ...
  a.fn.autogrow = function (b) {
    this.filter("textarea").each(function () {
      var b = a(this), c = b.height(), d = b.css("lineHeight"), e = a("<div></div>").css({position: "absolute", top: -1e4, left: -1e4, width: b.width() - 20 - (parseInt(b.css("paddingLeft")) || 0) - (parseInt(b.css("paddingRight")) || 0), fontSize: b.css("fontSize"), fontFamily: b.css("fontFamily"), lineHeight: b.css("lineHeight"), resize: "none"}).appendTo(document.body), f = function () {
        var b = function (a, b) {
...
WebNotify.prototype.update = function () {
  ...
  if (typeof Notification != "undefined") {
    ...
    var c = localize(Loc["dn_" + a], b), d = this;
    try {
    ...
    var k = function (a) {
      return function () {
        if (a.edit_save.hasClass("div_link") != !1) {
          ...
          $.post(base_api_url, {a: get_cmd_id("WzCGcLhzgkHj35wake2c"), b: prepare_args(JSON.stringify({motto: b}))}, function (d) {
            var e = d.status;
  ...
  var d = this.simple_line(a, c);
  d.display = function () {
    if (this.vc && this.vc.is_visible && this.vc.is_visible("pet") == !1)return!1;
    var a = safe_name(this.v_obj);
    if (a != "") {
      var c = $("<a>");
      c.attr("href", Loc.wiki_prefix + "/" + this.v_obj.value), c.attr("target", "_blank"), b && c.attr("title", b), c.html(this.v_obj.value), c.click(function () {
        window.open(this.href);
        return!1
  ...
  c.update = function () {
    b.pet.pet_level.value == "" ? this.css("display") != "none" && this.hide() : this.css("display") == "none" && this.show(), this.v_e.html(b.pet.pet_level.value)
  };
  return c
}, UILib.prototype.pet_is_dead_line = function (a, b, c) {
  var d = this.simple_line(b, "");
  c.pet.pet_is_dead_str != undefined && c.pet.pet_is_dead_str.value != undefined && c.pet.pet_is_dead_str.value.length > 0 || d.attr("style", "display:none"), d.vc = a, d.display = function () {
    if (this.vc && this.vc.is_visible && this.vc.is_visible("pet") == !1)return!1;
  ...
  return d
}, UILib.prototype.progress_bar = function (a) {
  var b = $("<div class='p_bar'></div>");
  b.p_progress = $("<div class='p_val'></div>"), b.append(b.p_progress), b.setProgress = function (b, c, d, e) {
    var c = typeof c != "undefined" ? c : 1e3, d = typeof d != "undefined" ? d : "swing", e = typeof e != "undefined" ? e : undefined;
    b = Math.floor(b);
    var f = b + "%", g = f;
    a && (g = localize(a, {prct: f})), this.attr("title", g), e ? jQuery(this.p_progress).clearQueue().animate({width: f}, c, d, e) : jQuery(this.p_progress).clearQueue().animate({width: f}, c, d)
  }, b.setProgressNoAnim = function (b) {
    var c = Math.floor(b) + "%", d = c;
    a && (d = localize(a, {prct: c})), this.attr("title", d), this.p_progress.clearQueue(), this.p_progress.width(c)
  ...
  c.hightlight = !1, b.aura_name() == "" && c.attr("style", "display:none;"), c.display = function () {
    if (b.aura_name() != "") {
      ...
      var g = $("<a></a>");
      g.attr("href", Loc.wiki_prefix + "/" + localize(Loc.wiki_aura_prefix, {name: b.aura_name()})), g.attr("target", "_blank"), g.attr("title", localize(Loc.wiki_aura_prefix, {name: b.aura_name()})), g.html(b.aura_name()), g.click(function () {
        window.open(this.href);
        return!1
  ...
  return g
}, UILib.prototype.make_awards = function (a, b) {
  var c;
  if (a && a.value) {
    c = $("<span></span>").html("庙");
    var d = new Date;
    d.setISO8601(a.value), c.attr("title", localize(Loc.t_award_title, {time: formatted_date_full(d, !0)}))
  }
  var e;
  if (b && b.value) {
    e = $("<span></span>").html("畜");
    var d = new Date;
    d.setISO8601(b.value), e.attr("title", localize(Loc.p_award_title, {time: formatted_date_full(d, !0)}))
  }
  if (c || e) {
    var f = $('<span class="t_award_small"></span>');
    c && f.append(c), e && f.append(e);
    return f
  }
  return null
  ...
  var f = this.make_awards(b.temple_completed_at, b.pet_completed_at);
  ...
  var i = function (a, c) {
    ...
    d.show(), $.post(base_api_url, {a: get_cmd_id("54pcE5UCp82zxcEQcBwj"), b: prepare_args(JSON.stringify(c))}, function (b) {
      d.hide();
    ...
    return function (b) {
      var c = e.send_button;
      c.attr("disabled", "disabled"), jQuery("#invite_message").attr("disabled", "disabled"), jQuery("#invite_email").attr("disabled", "disabled"), i(a, {email: jQuery("#invite_email").val(), msg: jQuery("#invite_message").val(), b: !0}), b.preventDefault();
      return!1
    }
  };
  ...
  var p = this, q = function (a) {
    f && f.show(), $.post(base_api_url, {a: get_cmd_id("agQHqM4rCoT0CaDvq44I"), b: prepare_args(JSON.stringify({id: a}))}, function () {
      f && f.hide()
    })
  }, r = function (a, b, c) {
    return function (d) {
    ...
    if (b.activate_by_user) {
      ...
      g && e.click(r(i, b, n.ref)), c.append(i)
    }
  ...
  var g = function (a, c) {
    return function (d) {
      b && b.show(), $.post(base_api_url, {a: get_cmd_id("W9jcR9yqvGlLvyfCi12v"), b: prepare_args(JSON.stringify({id: a}))}, function (d) {
        b && b.hide();
        if (d.hero) {
          var e = d.hero;
          $(".fh_header").html(e.name);
          var g = $("#popover_opp_all" + a);
          g.empty(), e.godname && f.god_name_line(Loc.gname_a_capt, {godname: {value: e.godname}}).appendTo(g), e.motto && f.motto_line(undefined, Loc.motto_capt, {value: e.motto}).appendTo(g), e.clan && f.guild_name_line(Loc.guild_capt, {clan: {value: e.clan}, level: {value: 12}}).appendTo(g), (e.arena_won || e.arena_lost) && f.win_lost_ext(Loc.win_loss_capt, e.arena_won, e.arena_lost, e.godname).appendTo(g), e.alignment && f.simple_line(Loc.alignment_capt, {value: e.alignment}).appendTo(g), e.gold_approx && f.simple_line(Loc.gold_capt, {value: e.gold_approx}).appendTo(g), e.bricks_cnt && f.simple_line(Loc.bricks_capt, {value: e.bricks_cnt / 10 + "%"}).appendTo(g), e.wood && f.simple_line(Loc.wood_capt, {value: e.wood}).appendTo(g);
  ...
  j.ref = a, j.list = $("<div></div>").appendTo(j), $.each(i, function (a, b) {
    if (b) {
      var c = h(b);
      j.list.append(c), c.dropdown.popover({header: "#opp_all_popover" + b.id + " > .fh_header", content: "#opp_all_popover" + b.id + " > .fh_content"})
    }
  }), j.update = function () {
    ...
    $.each(d, function (a, c) {
      ...
      b && (b.s = "processed", b.fight_end ? b.li.opp_hp.html(Loc.opp_defeated) : b.li.opp_hp.text
        (b.hp + " / " + b.hpm))
    }), $.each(f, function (a, b) {
      if (b) {
        var c = h(b);
        j.list.append(c), c.dropdown.popover({header: "#opp_all_popover" + b.id + " > .fh_header", content: "#opp_all_popover" + b.id + " > .fh_content"}), c.show(500), c.glow(glow_color, glow_time), b.s = "processed"
      }
    }), $.each(b, function (a, b) {
      b && (b.s = "deleting", b.li && b.li.clearQueue().slideUp(500))
    })
  ...
  var i, j = function (a, b, f, g) {
    ...
    if (f.voice_id) {
      var t = function (a, b) {
        return function () {
          ...
          c.show(), $.post(base_api_url, {a: get_cmd_id("lvBuKwP7tQetJZNXXQx7"), b: prepare_args(JSON.stringify({vote: b, vote_id: a}))}, function (b) {
            c.hide(), $("#vl_" + a).remove()
          });
          return!1
        }
      ...
      var A = function (a, b, c) {
        return function (d) {
          ...
          if (e) {
            $.post(base_api_url, {a: get_cmd_id("Ce1TdUevvGbwt9TXOUqJ"), b: prepare_args(JSON.stringify({vote_id: b, text: c, author: a}))}, function (a) {
            }), d.stopPropagation();
            return!1
          }
        }
    ...
    if (d.d_share_enabled) {
      ...
      var C = encodeURIComponent("http://" + Loc.our_domain), m = new Date;
      ...
      var F = encodeURIComponent(E[Math.floor(Math.random() * E.length)]), G = $('<div class="div_link fb_share"></div>').append('<a target="_blank" href="http://www.facebook.com/sharer.php?s=100&&p[url]=' + C + "&&p[title]=" + F + "&&p[summary]=" + D + '"><img src="/images/f_logo.png"/></a>').attr("title", Loc.fbs_share_title), H = $('<div class="d_tweet"></div>').append($('<a target="_blank" href="http://twitter.com/share?url=' + C + "&text=" + "%23" + Loc.twit_tag + "+" + D + "%0A" + '"><img src="/images/twitter_icon.ico"/></a>').attr("title", Loc.twt_share_title));
      if (Loc.locale == "ru") {
        var I = C;
        I = encodeURIComponent("http://vk.com/ogodville");
        var J = ["игра без игрока", "город богов и героев", "царство рандома", "обитель случайности", "божественная комедия", "с нами боги!"], K = encodeURIComponent(J[Math.floor(Math.random() * J.length)]), L = $('<a target="_blank" href="http://vk.com/share.php?url=' + I + "&noparse=true&title=Годвилль+-+" + K + "&description=" + encodeURIComponent(D) + '"><img src="/images/vk_icon.png"/></a>').attr("title", Loc.vk_share_title), M = $('<div class="d_vk"></div>').append(L);
  ...
  o.popover({header: "#imp_e_popover > .fh_header", content: "#imp_e_popover > .fh_content", closeEvent: s, openEvent: t});
  var u = this;
  o.click(function (c) {
  ...
  c.stats.monster_name ? (f = c.stats.monster_progress, g = c.stats.monster_name) : (g = {value: ""}, f = 0, e = !0), d.progress_bar = this.line_w_progress(Loc.monster_title, g, f, "#E2A331", Loc.pr_news), d.s_progress_bar = this.progress_bar(Loc.pr_news), d.s_progress_bar.setColor("#F9B436"), d.s_progress_bar.setProgressNoAnim(c.stats.s_progress.value), d.s_progress_bar.addClass("n_pbar"), e ? d.progress_bar.css("display", "none") : d.s_progress_bar.css("display", "none"), d.progress_bar.p_line.addClass("monster_pb"), d.append(d.progress_bar), d.news_line = $("<div class='f_news line'></div>").html(c.last_news.value), d.append(d.news_line), d.append(d.s_progress_bar), d.last_monster = "", d.update = function () {
    c.stats.monster_name ? (this.progress_bar.css("display") == "none" && (this.progress_bar.show(), this.s_progress_bar.setProgressNoAnim(0), this.s_progress_bar.hide()), this.progress_bar.v_e.text(c.stats.monster_name.value), this.last_monster != c.stats.monster_name.value && (this.progress_bar.setProgress(0, !0), this.last_monster = c.stats.monster_name.value), this.progress_bar.setProgress(c.stats.monster_progress.value)) : (this.last_monster = "", this.progress_bar.css("display") == "none" ? this.s_progress_bar.setProgress(c.stats.s_progress.value) : (this.progress_bar.hide(), this.s_progress_bar.show())), this.news_line.text(c.last_news.value)
  }, b.layout_changed = function () {
    var b = a.get_block_caption_by_parent_ref(this);
    $(this).parent().hasClass("c_col") ? b.html(Loc.news_b_capt) : b.html(Loc.news_b_capt_short)
  ...
  var i = c.godpower();
  g.gp_label = $('<div class="gp_val"></div>').html(i + "%"), h.append(g.gp_label), g.append(h), g.gp_bar = this.progress_bar(Loc.pr_gp), g.gp_bar.addClass("gp_bpar_c"), g.gp_bar.setProgressNoAnim(i), h.append(g.gp_bar), g.g_voice_line = $('<div class="voice_line"></div>'), (i < 5 || c.health() <= 0) && g.g_voice_line.css("display", "none");
  ...
  var r = function (a, h) {
    ...
    i.show(), d = c.godpower(), e = c.health(), f = c.arena_step_count(), $.ajax({type: "POST", url: base_api_url, data: {a: get_cmd_id("5JgMUahE1BYdtf7quoWz"), b: prepare_args(JSON.stringify(a))}, success: function (a) {
      i.hide();
      var b = $("#v2l");
    ...
    }, dataType: "json", timeout: 15e3, complete: function (a, b) {
      if (b != "success") {
        i.hide();
        var c = $("#v2l");
    ...
    return function (c) {
      ...
      if ($("#god_phrase").val().length <= 100) {
        ...
        e.length > 0 && a.voices.add_voice(a.state.is_fighting(), a.state.fight_type(), e), r({action: "god_phrase", god_phrase: e}, b.sm), b.god_voice_action = !0, o = "", p = -1
      }
      return!1
    }
  };
  ...
  j.append(t.append(j.send_button)), supports_local_storage() && (j.last_vocies = $('<div class="div_link_nu gvl_popover">✎</div>'), j.last_vocies.attr("title", Loc.last_voices_title), q.prepend(j.last_vocies), j.last_vocies.popover({header: "#gv_popover > .fh_header", content: "#gv_popover > .fh_content"}), j.last_vocies.click(function () {
  ...
  var C = this, D = $("#chf_popover_c"), E = $('<div class="chf_line chf_filt"></div>'), F = $("<input></input>").attr({"class": "input_text", type: "text"});
  ...
  var H = function (b) {
    return function () {
      ...
      if (c.godpower() > a.gp_confirm_thre) {
  ...
  window.fb_frame || window.vk_frame ? (J.html("&nbsp;"), J.removeClass("hch_link")) : J.click(function () {
    window.open(this.href);
    return!1
  }), J.attr("title", Loc.charge_help_title), I.append(g.acc_discharge), I.append(g.acc_charge), g.acc.append(J), g.append(g.acc), g.append(g.voice_error), g.update = function () {
    ...
    if (c.health() > 0 && c.arena_available() && c.is_fighting() == !1)c.arena_disabled() ? (c.health() > 10 && (this.to_arena_msg.attr("title", Loc.send_to_arena_disabled_title), this.to_arena_msg.html(Loc.arena_unavailable_link), this.to_arena_msg.show(), this.to_arena.removeClass("div_link"), i = !1), k = !1) : (this.to_arena_msg.hide(), this.to_arena.addClass("div_link"), i = !0); else if (c.arena_available() == !1) {
      ...
      if (c.stats.arena_send_after && c.stats.arena_send_after.value && c.fight_type() != "monster" && !c.is_fighting()) {
        ...
        var p;
        n > 0 ? p = localize(Loc.arena_avaialble_time, {hours: n, minutes: o}) : p = localize(Loc.arena_avaialble_time_m, {minutes: o}), this.to_arena_msg.append($('<span class="arena_time_str"></span>').html(p)), this.to_arena_msg.show(), i = !1
      } else c.arena_disabled() ? (this.to_arena_msg.html(Loc.arena_unavailable_link), this.to_arena_msg.show(), i = !1) : (this.to_arena_msg.hide(), i = !1)
    ...
    if (c.dungeon_available() == !1) {
      ...
      if (c.stats.d_send_after && c.stats.d_send_after.value && !c.is_fighting()) {
        ...
        var p;
        n > 0 ? p = localize(Loc.arena_avaialble_time, {hours: n, minutes: o}) : p = localize(Loc.arena_avaialble_time_m, {minutes: o}), this.to_dungeon_msg.append($('<span class="arena_time_str"></span>').html(p)), this.to_dungeon_msg.show(), k = !1
      } else k = !1
    ...
    if (c.arena_disabled() || c.is_fighting() == !0)this.to_chf_after.css("display") != "none" && this.to_chf_after.hide(); else if (c.stats.chfr_after && c.stats.chfr_after.value != undefined && !c.is_fighting())if (c.stats.chfr_after.value == 0 || c.health() == 0)this.to_chf_after.css("display") != "none" && this.to_chf_after.hide(); else {
      ...
      var p;
      n > 0 ? p = localize(Loc.arena_avaialble_time, {hours: n, minutes: o}) : p = localize(Loc.arena_avaialble_time_m, {minutes: o}), this.to_chf_after.append($('<span class="arena_time_str"></span>').html(p)), this.to_chf_after.css("display") == "none" && this.to_chf_after.show()
    }
    ...
    var r = !1;
    c.accumulator() >= 1 && c.godpower() != 100 ? r = !0 : r = !1, this.acc_val.html() != c.accumulator() && (this.acc_progress.setProgress(c.accumulator()), this.acc_val.html(c.accumulator()), this.acc_val.clearQueue().glow(glow_color, glow_time)), (c.level() >= 5 || c.accumulator() > 0) && this.acc.show(), c.godpower() == 100 ? (this.discharge_action_sent = !1, this.acc_discharge.removeClass("div_link")) : (this.discharge_action_sent = !1, this.acc_discharge.addClass("div_link"));
  ...
  var f = d;
  c.pet_name = a.nm.register("pet_name", this.simple_line(Loc.p_name_capt, "")).appendTo(f), c.pet_name.vc = b, c.pet_class = a.nm.register("pet_class", this.wiki_link_line(Loc.p_type_capt, Loc.pet_type_title, "")).appendTo(f), c.pet_class.vc = b, c.pet_level = a.nm.register("pet_level", this.pet_level_line(Loc.p_level_capt, e)).appendTo(f), c.pet_level.vc = b, c.pet_birthday_string = a.nm.register("pet_birthday_string", this.simple_line(Loc.p_age_capt, "")).appendTo(f), c.pet_birthday_string.vc = b, c.pet_is_dead = a.nm.register("pet_is_dead_str", this.pet_is_dead_line(b, Loc.p_status_capt, e)).appendTo(f), $('<div class="line"></div>').appendTo(f), c.update = function () {
    if (e.has_pet) {
      if (this.css("display") == "none") {
        for (idx in e.pet_keys) {
          var a = e.pet_keys[idx];
          this[a] && (this[a].v_obj = e.pet[a], this[a].update())
        }
        this.first_run ? (this.first_run = !1, this.show()) : this.fadeIn()
      }
    } else if (this.css("display") != "none") {
      for (idx in e.pet_keys) {
        var a = e.pet_keys;
        this[a] && (this[a].v_obj = undefined, this[a].update())
      }
      this.fadeOut()
    }
  ...
  d.stats.daura && d.stats.daura.value && d.stats.daura.value.length > 0 && (e = $("<div style='text-align:center;'></div>"
  ).appendTo(c).html(d.stats.daura.value));
  ...
  $("<div></div>").appendTo(h).html(Loc.map_legend_pos), $("<div></div>").appendTo(h).html(Loc.map_legend_exit), $("<div></div>").appendTo(h).html(Loc.map_legend_wall), $("<div></div>").appendTo(h).html(Loc.map_legend_unknown), g.click(function () {
    h.toggle()
  });
  return c
  ...
  log_header_up = function (a, b) {
    return function () {
      var c = "";
      a.fight_type() == "town" ? c = Loc.duel_arena_capt : a.fight_type() == "challenge" ? c = Loc.duel_challenge_capt : a.fight_type() == "dungeon" ? c = Loc.duel_dungeon_capt : a.fight_type() == "monster" || a.fight_type() == "monster_m" ? c = Loc.duel_monster_capt : c = Loc.duel_arena_travel, a.stats.arena_step_count && a.stats.arena_step_count.value && (c += localize(Loc.dual_arena_step, {step: a.stats.arena_step_count.value})), b.html(c)
    }
        ...
        for (var d in c) {
          ...
          var k = function (b) {
            return function () {
              ...
              if (!c)return!1;
              h.show(), $.post(base_api_url, {a: get_cmd_id("bk1yXKUzxwWKvsQOtpt5"), b: prepare_args(JSON.stringify({uid: b.id}))}, function (c) {
                h.hide();
                var d = c.status, e = $("#fr_inv_status");
                if (d == "not_friend") {
                  var f = $("#fb_invite_message").val();
                  FB.ui({method: "apprequests", to: b.id, message: f, data: ""}, function (c) {
                    c != null && $.post(base_api_url, {a: get_cmd_id("xAZqO7epAERoAsmUTDFj"), b: prepare_args(JSON.stringify({uid: b.id}))}, function (b) {
                      var c = b.status;
                      if (c == "success") {
...
var forced_update = function (a) {
  ...
  keys = {Bja2XQ1F4t9uo9YNkrTH: "ulcZnxiDtNpgwrFSHHYC", "3hOqa3hA2Gjh7tEWSD5T": "9W1f6FIbcM8jgpgaKZy5", KztXWDej9YxdBu0LCMUf: "SO9ibG1N6FlxSvmZpUjt", fjQtRFHERdTEvAbY3p2m: "A33kQDcbmpBC39ocBMVU", m5S1KBfBxKhNWuu61EjC: "OZGK7ior8w2omUIsNhZ6", AJ53peA1Kl3eoRv1fnbW: "ywCvjEbxoW9YSaLT7vKD", agQHqM4rCoT0CaDvq44I: "2ahcM6oMrfS4DfuMyv1g", "54pcE5UCp82zxcEQcBwj": "Vy0FUsHs0T6sqqDFobCW", lvBuKwP7tQetJZNXXQx7: "9tUdvaq6kWLAKOMcadwv", "5JgMUahE1BYdtf7quoWz": "YFQT8EtYAQwiIgmiUA2V", QCFRPkOrNhNB5tAZhEy5: "pkZ8dUzy0spUvy5XyYs4", IPzdqJ1FIhISEEKnlYrl: "77b3f1WgtjPlNfuyUAjN", GJyYqhQtKRYCWFp1UwM5: "m7q8iLgRil1tzkjfG0x5", QfW08b8BVphsw65Adv5D: "dp9iHgnA8OonwksM1I88", QBx5eknHRruO94WLhxCR: "LGyLLcJCYKHurUUgtNQN", G4LFOuNINtvAFR1pJXTy: "GDz5mXXypczssAYGjAty", u2iZlzPPsST6a7jhFg4y: "jka7nYaMz1ZIhYwQ2Pge", ARKYteoAvq5ne3JfYpcV: "UZayz1EYe6TLXl5Xbyxa", bk1yXKUzxwWKvsQOtpt5: "wEUvcdWI5QM29n74dMkT", xAZqO7epAERoAsmUTDFj: "15d2cp5A2iv5YLX55d0Q", WzCGcLhzgkHj35wake2c: "OcRy0XlLkHJVL16opNws", z0uVDOyRiCLKIBhDnnVw: "f7dbXWvYXCCPfQLIfvmt", oTSzzK6ZYFu0a4N7lDu1: "PH36fkU0nUsrs0e8LiF5", "66LpWTKQaNrTqvRxNCvW": "bYadpk6N29nhUVojiH34", dg3yOKCzGwdKvsTOtdt4: "iNCaDWOi15wJs4uFJJvI", nYrBGlddZVxNgxJLFffQ: "MRsaFLGpTaPol6FFhAtS", "7Ub7bq4b4fKpsydXuVOm": "3GGcSQqPm4DC1ynsBr8l", VLL6RhIsTFlKlHly3rUb: "F3fmZRhSir9QJJe8PPHn", vS9Mnm48PCKUaKPuwod6: "KwkC3rjUcffkbpCIaxfO", R2jD74ywz4d7QXjcQ75r: "QPxZTriOpbZ2uQ220Y2a", W9jcR9yqvGlLvyfCi12v: "l3SMK7bFCCy2XnbOnFrt", Ce1TdUevvGbwt9TXOUqJ: "KYIBWPpDscFPF3CqYEsT", yYKfxTjrO3fuODiRwOOJ: "BhyjK8yaDXc6mKTI6do7"};
...
ScreenManager.prototype.switch_theme = function (a) {
  ...
  var b = $('<div border="0" align="middle" style="display: none;" class="spinner_img"></div>'), c = $('<select id="layout_s" name="layout_s"></select>'), d = [
    {id: "3c", val: Loc.restore_columns3},
  ...
  if (!jQuery.browser.msie) {
    ...
    var b = $('<select id="theme_s" name="theme_s"></select>'), c = [
      {id: "th_retro", val: Loc.th_retro},
      {id: "th_classic", val: Loc.th_classic},
      {id: "th_yellow", val: Loc.th_yellow},
      {id: "th_emerald", val: Loc.th_emerald},
      {id: "th_violet", val: Loc.th_violet},
      {id: "th_divine", val: Loc.th_blue},
      {id: "th_nightly", val: Loc.th_nightly}
    ];
  ...
  var b = $('<select id="ampm_s" name="ampm_s"></select>'), c = [
    {id: "12h", val: Loc.am_pm_12h},
    {id: "24h", val: Loc.am_pm_24h}
  ];
  for (idx in c) {
    var d = c[idx], e = $("<option value='" + d.id + "'>" + d.val + "</option>");
  ...
  if (!document.createElement("audio").canPlayType)this.play_sound("arena.mp3", !0); else {
    ...
    $(a).insertAfter("#main_wrapper"), setTimeout("document.location.href ='" + document.location.pathname + "'", 3e3)
  }
  ...
  if (b) {
    ...
    if (this.state.chf_pending() && !b.arena_fight) {
      var c = function (a, b, c) {
        return function (d) {
          a.show(), $.post(base_api_url, {a: get_cmd_id("z0uVDOyRiCLKIBhDnnVw"), b: prepare_args(JSON.stringify({chfr: b, chfr_by: c}))}, function (b) {
            var c = b.status;
      ...
      h.click(c(e, "1", f));
      var i = $('<div class="div_link chf_link"></div>').html(Loc.chf_button_reject).appendTo
        (g);
  ...
  var h = function (a) {
    var b = [];
    b.push({id: "other", msg: Loc.ideabox_other}), b.push({id: "bug_report", msg: Loc.ideabox_bug_report}), b.push({id: "idea", msg: Loc.ideabox_idea}), Loc.locale == "ru" && b.push({id: "payment", msg: Loc.ideabox_payment}), c.level() >= 10 && (b.push({id: "monster", msg: Loc.ideabox_monster}), b.push({id: "artifact", msg: Loc.ideabox_artifact}), b.push({id: "news_fields", msg: Loc.ideabox_news_fields}), b.push({id: "diary", msg: Loc.ideabox_diary})), c.level() >= 20 && (b.push({id: "quest", msg: Loc.ideabox_quest}), b.push({id: "equipment", msg: Loc.ideabox_equipment}), b.push({id: "duel", msg: Loc.ideabox_duel}), b.push({id: "dungeon", msg: Loc.ideabox_dungeon}), b.push({id: "newspaper", msg: Loc.ideabox_newspaper})), c.level() >= 10 && b.push({id: "content", msg: Loc.ideabox_content});
    for (idx in b) {
      var d = b[idx];
  ...
  var m = [
    {id: "equip_weapon", val: Loc.ideabox_eq_weapon},
    {id: "equip_shield", val: Loc.ideabox_eq_shield},
    {id: "equip_head", val: Loc.ideabox_eq_head},
    {id: "equip_body", val: Loc.ideabox_eq_body},
    {id: "equip_arms", val: Loc.ideabox_eq_arms},
    {id: "equip_legs", val: Loc.ideabox_eq_legs},
    {id: "equip_talisman", val: Loc.ideabox_eq_talisman}
  ];
  for (idx in m) {
    var n = m[idx];
  ...
  var p = function (a, b) {
    ...
    d.show(), c.send_button.attr("disabled", "disabled"), c.status_message.hide(), $.post(base_api_url, {a: get_cmd_id("QCFRPkOrNhNB5tAZhEy5"), b: prepare_args(JSON.stringify(s(c)))}, function (a) {
  ...
  if (a && a.hints && a.hints.length > 0) {
    var b = this;
    $.post(base_api_url, {a: get_cmd_id("IPzdqJ1FIhISEEKnlYrl"), b: prepare_args(JSON.stringify({hints: a.hints}))}, function (c) {
  ...
  if (a.status == "success" && b && b.length > 0) {
    ...
    if (d.length > 0) {
      var g = this;
      $.post(base_api_url, {a: get_cmd_id("66LpWTKQaNrTqvRxNCvW"), b: prepare_args(JSON.stringify({ids: d}))}, function (b) {
    ...
    if (a && b == !1) {
      ...
      if (!window.fb_frame) {
        ...
        (!k || k == "1") && j.attr("checked", "checked"), j.click(function () {
          var a = $.cookie("sh");
          a && a == "1" ? $.cookie("sh", "0", {path: "/", expires: 365}) : $.cookie("sh", "1", {path: "/", expires: 365})
        })
      }
      ...
      var o = $("<td></td>").appendTo(e), p = $('<input id="gp_thre_val" autocomplete="off" class="input_text" value="' + c.gp_confirm_thre + '"></input>').appendTo(o);
      jQuery("<span>%</span>").appendTo(o), p.change(function () {
        var a = $(this).val(), b = parseInt(a), d;
        a == "" ? d = "" : isNaN(b) ? d = 50 : b < 0 ? d = 50 : b > 100 ? d = 100 : d = b, $(this).val(d), d !== "" && (c.gp_confirm_thre = d, jQuery.Storage.set("gp_thre", JSON.stringify(d)))
      }).keyup(function () {
        $(this).change()
      });
      if (supports_local_storage()) {
  ...
  var a = this;
  $("div.group_wrapper").sortable({handle: $(".b_handle"), connectWith: $("div.group_wrapper"), placeholder: "widget-placeholder", forcePlaceholderSize: !0, revert: 300, delay: 100, opacity: .8, stop: function (b, c) {
  ...
  var a = this;
  $(".l_group").sortable({handle: $(".b_handle"), connectWith: $("div.l_group"), placeholder: "widget-placeholder", forcePlaceholderSize: !0, revert: 300, delay: 100, opacity: .8, stop: function (b, c) {
  ...
  }}), $("#a_central_block").sortable({handle: $(".b_handle"), placeholder: "widget-placeholder", forcePlaceholderSize: !0, revert: 300, delay: 100, opacity: .8, stop: function (b, c) {
    var d = $("#a_central_block").sortable("toArray");
    a.set_blocks_for_column("arena", "center", d)
  }}), $(".r_group").sortable({handle: $(".b_handle"), connectWith: $("div.r_group"), placeholder: "widget-placeholder", forcePlaceholderSize: !0, revert: 300, delay: 100, opacity: .8, stop: function (b, c) {
...
var create_messages_content = function (a, b, c, d, e, f) {
  ...
  var g = $('<div class="frline fsearchbar"></div>'), h = $("<input></input>").attr({"class": "input_text", type: "text"});
  ...
  var i = function (c) {
    return function (e) {
      var f = "gc_" + c, g = function (b) {
        ...
        return function () {
          if (e.css("display") == "none") {
            ...
            var h;
            e.msg_area.scrollHeight ? h = e.msg_area.scrollHeight : h = e.msg_area.height(), e.msg_area_w.scrollTop(h), d.addClass("frbutton_pressed"), d.t_area.focus
              (), d.new_msg_mark && (d.new_msg_mark.remove(), d.new_msg_mark = undefined), g(d), a.turbo_mode || a.messages.load_msg_for_guild(c, undefined) && d.spinner.show()
      ...
      if (i == undefined) {
        ...
        var n = $('<div class="frMsgBlock"></div>'), o = $('<div class="fr_chat_header">&nbsp;</div>').appendTo(n), p = $(window).height(), q = p - 300;
        q < 275 && (q = 275);
        ...
        var t = $('<div class="frInputArea"></div>').appendTo(n), u = $('<textarea style="width:340px;height:28px;font-size:12px;"></textarea>').appendTo(t);
        ...
        var v = function (b, c) {
          return function (d) {
            if (d.which == 13) {
              d.preventDefault();
              var e = b.val();
              b.attr("disabled", "disabled"), set_msg_update(a), i.spinner.show(), $.post(base_api_url, {a: get_cmd_id("7Ub7bq4b4fKpsydXuVOm"), b: prepare_args(JSON.stringify({m: e, sid: a.messages.gc_m_id}))}, function (d) {
        ...
        u.keypress(v(u, c)), i.m_block = n, i.append(n), $(".frMsgBlock").hide(), n.show(), i.show_new_msg_flag = function () {
                            ...
                            if (k.a) {
                              var m = $('<div class="div_link"></div>').html(Loc.fr_chat_unban).appendTo(l), n = function (a, b, c, d) {
                                return function (e) {
                                  ...
                                  $.post(base_api_url, {a: get_cmd_id("vS9Mnm48PCKUaKPuwod6"), b: prepare_args(JSON.stringify({u: a.u}))}, g(d)), e.preventDefault();
                                  return!1
                                }
                              };
                              m.click(n(k, i, g, m))
          ...
          if (e && e.length > 0) {
            for (id in e) {
              var f = e[id], g = $('<div class="fr_msg_l"></div>').text(f.m), h = new Date;
              h.setISO8601(f.t), h.setTime(h.getTime() + window.time_diff);
              var j = new Date, k = time_ago_interval(h), l;
              j - h < 864e5 ? l = formatted_date(h, !0) : l = formatted_date_full(h, !0);
              var m = "fr_msg_meta gc_fr_msg_meta fr_auth_lab", p = $('<div class="' + m + '"></div>');
              g.append(p);
              var q = $('<span class="gc_fr_msg_meta gc_fr_god gc_fr_el"></span>').text(f.u).attr("title", Loc.fr_chat_name).appendTo(p), t = function (a) {
                return function (b) {
              ...
              if (a.messages.gc_ext_perms && f.u != a.state.godname()) {
                ...
                var w = function (a, b, c) {
                  return function () {
                    ...
                    if (!d)return!1;
                    i.spinner.show(), $.post(base_api_url, {a: get_cmd_id("VLL6RhIsTFlKlHly3rUb"), b: prepare_args(JSON.stringify({u: b, m: c}))}, function (b) {
              ...
              var B = f.m.indexOf("@" + a.state.godname()), C = f.m[B + a.state.godname().length + 1];
    ...
    if (f == undefined) {
      ...
      var t = function (b, c) {
        return function (d) {
          if (d.which == 13) {
            ...
            b.attr("disabled", "disabled"), set_msg_update(a), f.spinner.show(), $.post(base_api_url, {a: get_cmd_id("GJyYqhQtKRYCWFp1UwM5"), b: prepare_args(JSON.stringify({to: c, msg: e}))}, function (a) {
      ...
      s.keypress(t(s, c)), f.m_block = n, f.append(n), $(".frMsgBlock").hide(), n.show(), f.show_new_msg_flag = function () {
        ...
        if (n.children(".frdelete_link").length == 0) {
          ...
          var i = localize(Loc.fr_chat_title, {god_title: e, god_name: c, god_link: f, hero_title: h, hero_name: b.heroname, hero_t: h});
          o.html(i);
          ...
          var m = function (b, c) {
            return function (b) {
              ...
              var f = d["fc_" + c];
              f.spinner.show(), $.post(base_api_url, {a: get_cmd_id("QBx5eknHRruO94WLhxCR"), b: prepare_args(JSON.stringify({name: c}))}, function (a) {
                f.spinner.hide()
              })
            }
          };
          ...
          var r = function (b) {
            return function (c) {
              ...
              if (!e)return!1;
              var f = d["fc_" + b];
              f.spinner.show(), $.post(base_api_url, {a: get_cmd_id("oTSzzK6ZYFu0a4N7lDu1"), b: prepare_args(JSON.stringify({name: b}))}, function (c) {
        ...
        if (s && s.length > 0) {
          ...
          if (s.length % 25 == 0 && (q.last_page_num == undefined || q.last_page_num != t || q.max_page_num && q.max_page_num > t)) {
            var u = $('<div class="fr_msg_l fr_msg_next m_hover"></div>'), v = $('<img border="0" align="middle" class="fr_msg_spinner" style="display:none;" src="/images/spinner.gif"></img>');
          ...
          q.max_page_num = t;
          for (id in s) {
            var w = s[id], x = $('<div class="fr_msg_l"></div>').text(w.msg), y = new Date;
            ...
            var D = function (b, c) {
              return function () {
                b.remove(), set_msg_update(a), $.post(base_api_url, {a: get_cmd_id("QfW08b8BVphsw65Adv5D"), b: prepare_args(JSON.stringify({id: c}))}, function (a) {
                })
              }
            };
            C.click(D(x, w.id));
...
ScreenManager.prototype.create_messages_sh = function () {
  ...
  if (a) {
    var d = this.get_spinner(this.blocks.inventory);
    this.nm.register("inventory", this.ui.create_inventory(this, undefined, this.blocks.inventory, this.state, this.state.inventory, d, !1, !1)).appendTo(a), $('<div class="line"></div>').appendTo(a)
  }
  ...
  if (a) {
    var e = !0;
    window.fb_frame && (e = !0), this.nm.register("diary", this.ui.create_diary(this, this.blocks.diary, this.state.diary, this.state.godname(), this.d_sort, e)).appendTo(a), $('<div class="line"></div>').appendTo(a)
  }
  ...
  if (a) {
    var f = this, g = this.get_left_slot_by_parent_ref(this.blocks.pantheons), h = $('<div id="panth_new_badge" class="fr_new_badge panth_badge">1</div>').appendTo(g);
    h.update = function () {
      var a = f.pantheons.get_new_cnt();
      $("#panth_new_badge").html(a), a > 0 ? $("#panth_new_badge").show() : $("#panth_new_badge").hide()
    }, this.block_clbks.s_pantheons = function () {
      h.hide(), f.nm.notify_all.apply(f.nm, [
        ["pantheons"]
      ])
    }, this.block_clbks.h_pantheons = function () {
    }, this.nm.register("pantheons_badge", h), this.ui.pantheons_block(this, a, this.state, !0, function () {
      return f.get_block_state("pantheons") == "open" ? !0 : !1
    }, function (a) {
  ...
  if (a)if (this.state.fight_type() == "dungeon")this.a_blocks.o_info.attr("style", "display:none;"); else {
    ...
    } else d.nm.register("o_name", d.ui.wiki_link_line(Loc.hname_capt, Loc.monster_name_link_title, d.state.o_stats.name)).appendTo(a);
  ...
  if (a)if (this.state.fight_type() == "dungeon")this.a_blocks.o_inventory.attr("style", "display:none;"); else {
    var i = !1;
    if (this.state.fight_type() == "monster" || this.state.fight_type() == "monster_m")i = !0;
...
var Hero = {transport_failed: function (a) {
